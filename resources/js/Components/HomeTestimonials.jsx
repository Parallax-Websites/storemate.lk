...
const testimonials = [
    ...
    {
        quote: "We truly appreciate the service support of Amalka who handled our technical matters. Her commitment, expertise, and responsiveness made the entire process smooth and stress-free. It's rare to find such responsible and customer-focused professionals. Highly recommended!",
        name: 'Diluk Fernando',
        role: 'Business Owner',
        color: 'bg-indigo-500',
    },
    ...
    {
        quote: 'StoreMate OMS system එක online business කරන්න ගොඩක් පහසු system එකක්. Products manage කරන්න, orders track කරන්න, catalog maintain කරන්න ඉතාමත් easy. User-friendly interface එකක් තියෙන නිසා ඕනම කෙනෙකුට ලේසියෙන් use කරන්න පුළුවන්. Customer service සහ support team එකත් ඉක්මනින් help කරනවා. Online business කරන අයට මේ system එක ගොඩක් useful. Highly recommended!',
        name: 'Nishanta Kumra',
        role: 'Online Seller',
...
function TestimonialCard({ testimonial, index, isVisible }) {
    ...
    const displayText = !expanded && isLong
        ? testimonial.quote.slice(0, TRUNCATE_LENGTH) + '...'
        : testimonial.quote;
