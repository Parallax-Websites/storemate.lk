        ...
        <div className="mx-auto max-w-2xl py-12 sm:py-18 lg:py-22">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="https://welcome.oms.storemate.cloud/register?utm_source=storemate_lk&utm_medium=web&utm_campaign=shipping&packing_page&utm_content=btn_start_a_free_trial_hero"
