...
export default function CampaignTrialModal({ isOpen, onClose }) {
    ...
    const handleSubmit = (e) => {
        ...
        try {
            ...
            fetch('https://n8n.parallaxtec.dev/webhook/e43adbc3-d11a-42a4-b43a-ba25d06a606f', webhookOptions);
            fetch('https://n8n.parallaxtec.dev/webhook/a33bf710-f163-4df6-88d8-c1ee49d024b5', webhookOptions);
            fetch('https://n8n.parallaxtec.dev/webhook/214bae8c-9265-40d2-a3b3-0e7797d70286', webhookOptions);
            fetch('https://n8n.parallaxtec.dev/webhook/ddaf83ef-859d-4d29-9f1e-e692443f98d6', webhookOptions);
