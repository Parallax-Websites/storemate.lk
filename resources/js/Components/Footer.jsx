                    ...
                    <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                        ...
                        <form onSubmit={handleSubscribe} className="mt-6">
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
                                style={{backgroundColor: isSubmitting ? '#6B7280' : '#2563EB'}}
                                onMouseEnter={(e) => {
