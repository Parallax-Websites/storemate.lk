                    ...
                    <div>
                        ...
                        {showingMobileMoreDropdown && (
                            <div className="pl-8 pb-2 space-y-1">
                                ...
                                <a href={route('blog')} className="block px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-50 transition duration-150 ease-in-out">
                                    {t('nav.blogs')}
                                </a>
                            </div>
                        )}
