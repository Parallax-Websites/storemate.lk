            ...
            <div className="relative max-w-4xl mx-auto text-center">
                ...
                <div className="mb-6">
                    <span className="inline-block text-sm font-bold tracking-widest px-4 py-2 rounded-full" style={{
                        ...
                        🤝 {tPartnerProgram('partnerProgram.callToAction.badge')}
                    </span>
                </div>
                ...
                <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-8" style={{
                    ...
                    {tPartnerProgram('partnerProgram.callToAction.title')}
                </h2>

                {/* Description */}
                <div className="mb-12 max-w-3xl mx-auto">
                    <p className="text-lg text-gray-700 leading-relaxed mb-6">
                        {tPartnerProgram('partnerProgram.callToAction.description.part1')}
                    </p>
                    <p className="text-base text-gray-600 leading-relaxed">
                        {tPartnerProgram('partnerProgram.callToAction.description.part2')}
                    </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                    ...
                    >
                        ...
                        <span>{tPartnerProgram('partnerProgram.callToAction.buttons.call')}</span>
                    </a>
                    ...
                    >
                        ...
                        <span>{tPartnerProgram('partnerProgram.callToAction.buttons.visit')}</span>
                    </a>
                </div>

                {/* Bottom Features */}
                <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8">
                    {tPartnerProgram('partnerProgram.callToAction.features').map((feature, index) => (
