                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="rounded-3xl border border-slate-200 p-6 sm:p-8 lg:p-10 bg-gradient-to-br from-sky-50 to-orange-50">
                        <div className="flex flex-col md:flex-row gap-8 items-start justify-center">
                            {/* Guest User Card */}
                            <div className="flex-1 bg-white rounded-2xl shadow-md p-6 mb-6 md:mb-0 flex flex-col justify-start">
                                <div className="flex items-center mb-4">
                                    <svg className="w-7 h-7 mr-2 text-indigo-700" fill="currentColor" viewBox="0 0 20 20"><path d="M10 10a4 4 0 100-8 4 4 0 000 8zm-7 8a7 7 0 1114 0H3z" /></svg>
                                    <span className="font-bold text-lg text-slate-800">Guest User</span>
                                </div>
                                <ul className="space-y-4 text-base">
                                    <li className="flex items-center gap-2"><svg className="w-5 h-5 text-blue-500" fill="currentColor" viewBox="0 0 20 20"><path d="M3 3a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V3zm0 4h14v10a1 1 0 01-1 1H4a1 1 0 01-1-1V7zm2 2v6h2V9H5zm4 0v6h2V9H9zm4 0v6h2V9h-2z" /></svg> <span className="font-semibold">Excel Upload:</span> 20 Rows</li>
                                    <li className="flex items-center gap-2"><svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 8V5a1 1 0 10-2 0v5a1 1 0 00.293.707l3 3a1 1 0 101.414-1.414l-2.707-2.707z" /></svg> <span className="font-semibold">Data History:</span> Valid for 5 Hours</li>
                                    <li className="flex items-center gap-2"><svg className="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20"><path d="M17.414 2.586a2 2 0 00-2.828 0l-1.172 1.172-9.192 9.192a2 2 0 000 2.828l3.172 3.172a2 2 0 002.828 0l9.192-9.192a2 2 0 000-2.828l-3.172-3.172zM7.05 16.95a1 1 0 01-1.414 0l-3.172-3.172a1 1 0 010-1.414l9.192-9.192a1 1 0 011.414 0l3.172 3.172a1 1 0 010 1.414l-9.192 9.192z" /></svg> <span className="font-semibold">Logo & Branding:</span> Basic</li>
                                    <li className="flex items-center gap-2"><svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20"><path d="M17 8V6a5 5 0 00-10 0v2a2 2 0 00-2 2v5a2 2 0 002 2h10a2 2 0 002-2v-5a2 2 0 00-2-2zm-7-2a3 3 0 016 0v2H6V6zm8 7a1 1 0 01-1 1H5a1 1 0 01-1-1v-5a1 1 0 011-1h10a1 1 0 011 1v5z" /></svg> <span className="font-semibold">Courier Sync:</span> Manual</li>
                                </ul>
                            </div>
                            ...
                            {/* Logged-in User Card */}
                            <div className="flex-1 bg-white rounded-2xl shadow-md p-6 border-2 border-emerald-200 flex flex-col justify-start">
                                <div className="flex items-center mb-4">
                                    <svg className="w-7 h-7 mr-2 text-emerald-600" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 00-1.414 0L9 11.586 6.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l7-7a1 1 0 000-1.414z" /></svg>
                                ...
                                <ul className="space-y-4 text-base">
                                    <li className="flex items-center gap-2"><svg className="w-5 h-5 text-blue-500" fill="currentColor" viewBox="0 0 20 20"><path d="M3 3a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V3zm0 4h14v10a1 1 0 01-1 1H4a1 1 0 01-1-1V7zm2 2v6h2V9H5zm4 0v6h2V9H9zm4 0v6h2V9h-2z" /></svg> <span className="font-semibold">Excel Upload:</span> <span className="text-emerald-700">Bulk Processing (No Limits)</span></li>
                                    <li className="flex items-center gap-2"><svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20"><path d="M2.003 5.884L10 2l7.997 3.884A2 2 0 0120 7.764V16a2 2 0 01-2 2H4a2 2 0 01-2-2V7.764a2 2 0 01.003-1.88zM10 4.236L4.21 7.07A1 1 0 004 7.764V16h12V7.764a1 1 0 00-.21-.694L10 4.236z" /></svg> <span className="font-semibold">Data History:</span> <span className="text-emerald-700">Cloud Storage & Order History</span></li>
                                    <li className="flex items-center gap-2"><svg className="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20"><path d="M17.414 2.586a2 2 0 00-2.828 0l-1.172 1.172-9.192 9.192a2 2 0 000 2.828l3.172 3.172a2 2 0 002.828 0l9.192-9.192a2 2 0 000-2.828l-3.172-3.172zM7.05 16.95a1 1 0 01-1.414 0l-3.172-3.172a1 1 0 010-1.414l9.192-9.192a1 1 0 011.414 0l3.172 3.172a1 1 0 010 1.414l-9.192 9.192z" /></svg> <span className="font-semibold">Logo & Branding:</span> <span className="text-emerald-700">Fully Customizable Brand Kit</span></li>
                                    <li className="flex items-center gap-2"><svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20"><path d="M17 8V6a5 5 0 00-10 0v2a2 2 0 00-2 2v5a2 2 0 002 2h10a2 2 0 002-2v-5a2 2 0 00-2-2zm-7-2a3 3 0 016 0v2H6V6zm8 7a1 1 0 01-1 1H5a1 1 0 01-1-1v-5a1 1 0 011-1h10a1 1 0 011 1v5z" /></svg> <span className="font-semibold">Courier Sync:</span> <span className="text-emerald-700">Automated Fulfillment</span></li>
                                </ul>
                                <a
