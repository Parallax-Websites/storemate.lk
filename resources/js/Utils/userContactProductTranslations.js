...
export const userContactProductTranslations = {
    ...
    hero: {
        badge: {
            en: 'USER, CONTACT, PRODUCT',
            si: 'පරිශීලක, සම්බන්ධතා, නිෂ්පාදන',
            ta: 'பயனர், தொடர்பு, தயாரிப்பு'
        },
        title: {
            part1: {
        ...
        watchDemo: {
            en: 'Watch Demo',
            si: 'ආදර්ශන පෙන්වීම නරඹන්න',
            ta: 'டெமோ பார்க்கவும்'
        },
        imageAlt: {
            en: 'User Contact Product Management Dashboard',
            si: 'පරිශීලක සම්බන්ධතා නිෂ්පාදන කළමනාකරණ උපකරණ පුවරුව',
            ta: 'பயனர் தொடர்பு தயாரிப்பு மேலாண்மை டாஷ்போர்டு'
        }
    },
    ...
    userManagement: {
        ...
        stats: {
            usersManaged: {
                ...
                label: {
                    en: 'Users Managed',
                    si: 'කළමනාකරණය කරන ලද පරිශීලකයින්',
                    ta: 'நிர்வகிக்கப்படும் பயனர்கள்'
                }
            },
            rolePermissions: {
                value: {
        ...
        imageAlt: {
            en: 'User Management Dashboard',
            si: 'පරිශීලක කළමනාකරණ උපකරණ පුවරුව',
            ta: 'பயனர் மேலாண்மை டாஷ்போர்டு'
        }
    },
    ...
    productManagement: {
        ...
        stats: {
            productsTracked: {
                ...
                label: {
                    en: 'Products Tracked',
                    si: 'ලුහුබැඳ ගත් නිෂ්පාදන',
                    ta: 'கண்காணிக்கப்படும் தயாரிப்புகள்'
                }
            },
            inventoryAccuracy: {
                value: {
        ...
        imageAlt: {
            en: 'Product Management Dashboard',
            si: 'නිෂ්පාදන කළමනාකරණ උපකරණ පුවරුව',
            ta: 'தயாரிப்பு மேலாண்மை டாஷ்போர்டு'
        }
    },
    ...
    contactManagement: {
        ...
        stats: {
            contactsManaged: {
                ...
                label: {
                    en: 'Contacts Managed',
                    si: 'කළමනාකරණය කරන ලද සම්බන්ධතා',
                    ta: 'நிர்வகிக்கப்படும் தொடர்புகள்'
                }
            },
            responseTime: {
                value: {
        ...
        imageAlt: {
            en: 'Contact Management Dashboard',
            si: 'සම්බන්ධතා කළමනාකරණ උපකරණ පුවරුව',
            ta: 'தொடர்பு மேலாண்மை டாஷ்போர்டு'
        }
    },

    // Easy Organization Section
    easyOrganization: {
        brand: {
            name: {
                en: 'STOREMATE',
        ...
        stats: {
            efficiency: {
                ...
                label: {
                    en: 'Efficiency Boost',
                    si: 'කාර්යක්ෂමතා වැඩිදියුණු කිරීම',
                    ta: 'திறன் அதிகரிப்பு'
                }
            },
            timeReduction: {
        ...
        imageAlt: {
            en: 'Easy Organization Dashboard',
            si: 'පහසු සංවිධාන උපකරණ පුවරුව',
            ta: 'எளிய அமைப்பு டாஷ்போர்டு'
        }
    }
};

export const useUserContactProductTranslation = () => {
    const { currentLanguage } = useLanguage();

    const tUserContactProduct = (key, fallbackLanguage = 'en') => {
        const keys = key.split('.');
        let value = userContactProductTranslations;
    ...
    return { tUserContactProduct };
};

export const tUserContactProduct = (key, language = 'en') => {
    const keys = key.split('.');
    let value = userContactProductTranslations;
